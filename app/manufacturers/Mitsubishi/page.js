    ...
    <div className="min-h-screen bg-[#19232d] text-[#dcbb87]">
      ...
      <header className="relative h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0 bg-black opacity-20">
          <Image
            src="https://res.cloudinary.com/dn8lt4rqf/image/upload/v1736090986/Mitsubishi_soufvi.jpg"
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <p className="text-md lg:text-xl max-w-2xl mx-auto text-[#FFF]">
            Leading Innovation in Regional Jets for a More Connected World
          </p>
        </div>
      </header>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            { icon: Plane, label: "Aircraft Delivered", value: "200+" },
            { icon: Award, label: "Years of Excellence", value: "40+" },
            { icon: Users, label: "Employees Worldwide", value: "5,000+" },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg opacity-90 pl-7 lg:pl-0 pr-7 lg:pr-0">
            <p className="text-justify text-[#FFF] text-sm lg:text-lg">
              ...
              innovation. Their aircraft, such as the Mitsubishi Regional Jet
              (MRJ), represent a new generation of regional jets, designed to
              enhance passenger comfort while providing reliable and efficient
              air travel for regional routes.
            </p>
            <p className="text-justify text-[#FFF] text-sm lg:text-lg">
              Committed to sustainability, Mitsubishi is at the forefront of
              reducing emissions and noise levels, aiming to make air travel
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mb-8 opacity-90 text-[#FFF] text-sm lg:text-lg">
            Explore Mitsubishi’s range of regional jets, including the
