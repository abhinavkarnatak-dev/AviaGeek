    ...
    <div className="min-h-screen bg-[#19232d] text-[#dcbb87]">
      ...
      <header className="relative h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0 bg-black opacity-30">
          <Image
            src="https://res.cloudinary.com/dn8lt4rqf/image/upload/v1736090994/Cessna_tee1ro.jpg"
            alt="Cessna Background"
            layout="fill"
            objectFit="cover"
            priority={true}
          />
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">Cessna</h1>
          <p className="text-md lg:text-xl max-w-2xl mx-auto text-[#FFF]">
            Innovating General Aviation with Reliable Aircraft Solutions
          </p>
        </div>
      </header>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          {[ 
            { icon: Plane, label: "Aircraft Delivered", value: "250,000+" },
            { icon: Award, label: "Years of Excellence", value: "90+" },
            { icon: Users, label: "Employees Worldwide", value: "10,000+" },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg opacity-90 pl-7 lg:pl-0 pr-7 lg:pr-0">
            <p className="text-justify text-[#FFF] text-sm lg:text-lg">
              Cessna is a leader in general aviation, known for its innovative
              designs and reliable aircraft. From small single-engine planes to
              high-performance jets, Cessna delivers versatile and dependable
              aviation solutions that meet a range of needs, from personal
              aviation to business travel.
            </p>
            <p className="text-justify text-[#FFF] text-sm lg:text-lg">
              With a focus on safety, innovation, and quality, Cessna continues
              to set the standard in the aviation industry, offering aircraft
              that are trusted by pilots around the world.
            </p>
          </div>
        </div>
      </section>
