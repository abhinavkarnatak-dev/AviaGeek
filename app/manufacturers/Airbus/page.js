    ...
    <div className="min-h-screen bg-[#19232d] text-[#dcbb87]">
      ...
      <header className="relative h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0 bg-black opacity-30">
          <Image
            src="https://res.cloudinary.com/dn8lt4rqf/image/upload/v1736090991/Airbus_oj90co.jpg"
            alt="Airbus Background"
            layout="fill"
            objectFit="cover"
            priority={true}
          />
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">Airbus</h1>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            { icon: Plane, label: "Aircraft Delivered", value: "12,000+" },
            { icon: Award, label: "Years of Excellence", value: "50+" },
            { icon: Users, label: "Employees Worldwide", value: "140,000+" },
            { icon: Globe2, label: "Countries", value: "170+" },
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg opacity-90 pl-7 lg:pl-0 pr-7 lg:pr-0">
            <p className="text-justify text-[#FFF] text-sm lg:text-lg">
              Airbus is a global leader in aerospace, known for designing,
              manufacturing, and delivering top-tier commercial aircraft,
              helicopters, military transports, satellites, and launch vehicles.
              The company is at the forefront of innovation, constantly pushing
              the boundaries of technology to shape the future of aerospace.
            </p>
            <p className="text-justify text-[#FFF] text-sm lg:text-lg">
              With a strong commitment to sustainability, Airbus is also driving
              green aviation initiatives. These efforts are focused on making
              the skies cleaner and more efficient, contributing to a more
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="mb-8 opacity-90 text-[#FFF] text-sm lg:text-lg">
            Explore Airbus's full range of aircraft, from the efficient A320 to
            the cutting-edge A350.
          </p>
