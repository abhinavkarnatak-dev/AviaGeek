...
const Profile = ({ name = "Abhinav Karnatak" }) => {
      ...
      {isOpen && (
        <div className="absolute lg:right-0 top-full mt-2 w-56 bg-[#1c2831] rounded-lg shadow-lg py-2 border border-[#FFF] z-50">
          <div className="px-4 py-2">
            <p className="font-medium text-[#DCBB87]">{name}</p>
            <p className="text-sm text-[#FFF]">abhinav@example.com</p>
          </div>
          ...
          <div className="mt-2">
            <button className="w-full px-4 py-2 text-left text-red-500 flex items-center gap-2">
